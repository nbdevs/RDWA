...
|__PowerBI__|PowerBI offers a free trial and an educational license accessibility after expiry, in addition to this it is cheaper than its more expensive direct competitor Tableau The prevalence of PowerBI within the BI stacks of organisations in industry made me opt for PowerBI over Tableau as although tableau has superior visualisations, the capabilities of PowerBI are more extensive and include customizable visualisations and modelling capabilities superior to Tableau. These tabular modelling capabilities will be much more useful for utilising the star schema design effectively and capturing accumulating snapshot fact tables.|
